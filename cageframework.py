...
configFile = installDir + "/cage.cfg"
print(installDir)
config = ConfigParser.RawConfigParser()
config.read(configFile)

toolDir = installDir + config.get('cage', 'toolDir')
logDir = installDir + config.get('cage', 'logDir')
yes = config.get('cage', 'yes').split()
color_random=[color.HEADER,color.IMPORTANT,color.NOTICE,color.OKBLUE,color.OKGREEN,color.WARNING,color.RED,color.END,color.UNDERLINE,color.LOGGING]
random.shuffle(color_random)
cagelogo = color_random[0] + '''
    //   ) )  // | |     //   ) )  //   / /       //   ) )                                             
   //        //__| |    //        //____         //         ___                __      ___     ( ) //  
  //        / ___  |   //  ____  / ____         //        //   ) ) //   / / //   ) ) //   ) ) / / //   
 //        //    | |  //    / / //             //        //   / / //   / / //   / / //       / / //    
...
cagecoun = color.NOTICE + '''
Hello,

As we all know about Cage Council.
...
Thank you for all the sourport over the years, the cage team thanks you!
...
'''
def agreement():
    while not config.getboolean("cage", "agreement"):
        clearScr()
        print(termsAndConditions)
        print(mrrobot4)
        agree = raw_input("You must agree to our terms and conditions first (Y/n) ").lower()
        if agree in yes:
            config.set('cage', 'agreement', 'true')

class cage:
    def __init__(self):
        clearScr()
        self.createFolders()
        print (cagelogo + color.RED + '''
       }--------------{+} Coded By Cage {+}--------------{
       }--------{+}  GitHub.com/xzendercage/cageframework {+}--------{
    ''' + color.END + '''
    ...
    Yb      Yb   dP 88 Y88   88   88"Yb  88 88""Yb o.`Y8b
     ...
     ''')
        contributorsURL = 'https://api.github.com/repos/Cage/cage/contributors'
    ...
    def update(self):
        os.system("git clone --depth=1 https://GitHub.com/xzendercage/cage.git")
        os.system("cd cage && bash ./update.sh")
        os.system("cage")
...
class webHackingMenu:
    ...
    def __init__(self):
        ...
        print("   {99}-Back To Main Menu \n")
        choiceweb = raw_input(cagePrompt)
        clearScr()
        if choiceweb == "1":
            maine()
        elif choiceweb == "2":
...
class crips:
    ...
    def __init(self):
        ...
        self.gitRepo = "https://GitHub.com/xzendercage/Crips.git"
